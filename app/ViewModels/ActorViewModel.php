...
{   
    ...
    public function social()
    {
        return collect($this->social)->merge([
            'twitter'=>$this->social['twitter_id'] ? 'htts://twitter.com/'.$this->social['twitter_id'] : null,
            'facebook'=>$this->social['facebook_id'] ? 'htts://facebook.com/'.$this->social['facebook_id'] : null,
            'instagram'=>$this->social['instagram_id'] ? 'htts://instagram.com/'.$this->social['instagram_id'] : null,
        ]);
    }
    ...
    public function credits()
    {
        ...
        return collect($castMovies)->map(function($movie) {
            ...
            return collect($movie)->merge([
               ...
               'title'=> $title,
               'cahracter' => isset($movie['character'] ) ? $movie['character'] : '',
            ]);
