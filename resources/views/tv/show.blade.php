...
<div class="tv-info border-b border-gray-800">
    ...
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
       <img src="{{ $tvshow['poster_path'] }}" alt="parasite" class="w-64 lg:w-80">
       <div class="md:ml-24">
           ...
           <div class="flex flex-wrap items-center text-gray-400 text-sm">
            ...
            <span class="mt-1 ml-1 ">{{ $tvshow['vote_average'] }}</span>
      ...
      <div x-data="{isOpen: false}">
        ...
        <div class="mt-12">
            <button 
                 @click="isOpen = true"
                class="flex inline-flex items-center bg-yellow-500 text-gray-900 rounded font-semi-bold px-5 py-4 hover:bg-yellow-600 transition ease-in-out duration-150">
    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            ...
            <div class="mt-8">
                ...
                <div class="mt-2">
                    <a href="{{ url('actors', $cast['id']) }}" class="text-lg mt-2 hover:text-gray-300">{{ $cast['name'] }}</a>
                    <div class="flex items-center text-gray-400 text-sm mt-1">
                        <span class="mt-1 ">{{ $cast['character'] }}</span>
     ...
     @foreach ($tvshow['images'] as $image)
            ...
            <div class="mt-8">
                <a 
                   ...
                   "
                   href="#">
                    <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$image['file_path'] }}" class="">
                </a>
